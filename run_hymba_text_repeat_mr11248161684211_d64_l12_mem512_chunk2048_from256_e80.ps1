...
$outDir = ".\runs_hymba_text_repeat_mr11248161684211_d64_l12_mem512_chunk2048_from256_e80"
...
python external_baselines\hymba_text_repeat_runner.py `
  ...
  --sample_non_exact 10 `
  --print_non_exact 3 `
  --resume .\runs_hymba_text_repeat_mr11248161684211_d64_l12_mem256_from192_e80\checkpoint.pt
