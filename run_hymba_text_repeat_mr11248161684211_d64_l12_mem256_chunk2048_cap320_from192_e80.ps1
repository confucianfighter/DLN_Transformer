...
$outDir = ".\runs_hymba_text_repeat_mr11248161684211_d64_l12_mem256_chunk2048_cap320_from192_e80"
...
python external_baselines\hymba_text_repeat_runner.py `
  ...
  --sample_non_exact 10 `
  --print_non_exact 3 `
  --resume .\runs_hymba_text_repeat_mr11248161684211_d64_l12_mem192_from128_e60\best_recall_checkpoint.pt
